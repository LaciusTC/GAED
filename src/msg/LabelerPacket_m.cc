...
double LabelerPacket::getX() const
{
    return this->x;
}

void LabelerPacket::setX(double x)
{
    handleChange();
    this->x = x;
}

double LabelerPacket::getY() const
{
    return this->y;
}

void LabelerPacket::setY(double y)
{
    handleChange();
    this->y = y;
}
